...
## **Problem Statement: Linked-In Clone** :sparkles:
 - Creating a mobile app  using flutter which clone the structure of Linked In.
 - User must be able to post stories with 24 hour view like other social media platforms.
